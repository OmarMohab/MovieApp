<div class="mt-2">
    <a href="{{ route('tv.show', $tvshow['id']) }}">
        <img src={{ $tvshow['poster_path'] }}
         alt="Show Poster" class="hover:opacity-75 transition ease-in-out duration-150">
    </a>
    <div class="mt-2 text-sm">
        <a href="{{ route('tv.show', $tvshow['id']) }}" class="txt-lg mt-2 hover:text-gray:300">{{ $tvshow['name']}}</a>
